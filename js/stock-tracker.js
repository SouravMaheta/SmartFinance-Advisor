...
const StockTracker = (() => {
  ...
  const STOCK_CATALOG = [
    // Indian Equities (NSE/BSE) - Base in INR
    { symbol: 'RELIANCE', name: 'Reliance Industries', exchange: 'NSE', basePrice: 2980.50, dayChangePct: 1.25, currency: 'INR', sector: 'Energy & Telecom' },
    ...
    { symbol: 'HDFCBANK', name: 'HDFC Bank', exchange: 'NSE', basePrice: 1642.00, dayChangePct: -0.45, currency: 'INR', sector: 'Banking' },
    { symbol: 'INFY', name: 'Infosys Ltd', exchange: 'NSE', basePrice: 1845.00, dayChangePct: 1.80, currency: 'INR', sector: 'IT Services' },
    { symbol: 'ICICIBANK', name: 'ICICI Bank', exchange: 'NSE', basePrice: 1225.00, dayChangePct: 0.65, currency: 'INR', sector: 'Banking' },
    { symbol: 'TATAMOTORS', name: 'Tata Motors', exchange: 'NSE', basePrice: 985.00, dayChangePct: 2.10, currency: 'INR', sector: 'Automotive' },
    { symbol: 'ITC', name: 'ITC Limited', exchange: 'NSE', basePrice: 508.00, dayChangePct: 0.30, currency: 'INR', sector: 'FMCG' },
    { symbol: 'SBIN', name: 'State Bank of India', exchange: 'NSE', basePrice: 825.00, dayChangePct: -0.80, currency: 'INR', sector: 'Banking' },
    { symbol: 'BHARTIARTL', name: 'Bharti Airtel', exchange: 'NSE', basePrice: 1545.00, dayChangePct: 1.15, currency: 'INR', sector: 'Telecom' },
    { symbol: 'LT', name: 'Larsen & Toubro', exchange: 'NSE', basePrice: 3680.00, dayChangePct: 0.90, currency: 'INR', sector: 'Infrastructure' },
    { symbol: 'HINDUNILVR', name: 'Hindustan Unilever', exchange: 'NSE', basePrice: 2750.00, dayChangePct: -0.20, currency: 'INR', sector: 'FMCG' },
    { symbol: 'BAJFINANCE', name: 'Bajaj Finance', exchange: 'NSE', basePrice: 7290.00, dayChangePct: 1.40, currency: 'INR', sector: 'NBFC' },
    { symbol: 'WIPRO', name: 'Wipro Ltd', exchange: 'NSE', basePrice: 535.00, dayChangePct: 0.40, currency: 'INR', sector: 'IT Services' },
    { symbol: 'TITAN', name: 'Titan Company', exchange: 'NSE', basePrice: 3710.00, dayChangePct: 1.05, currency: 'INR', sector: 'Consumer' },
